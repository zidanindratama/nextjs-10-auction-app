...
const FormAddItem = () => {
  ...
  const preloadedValues = {
    ...
    isActive: true ? "ACTIVE" : "NOT ACTIVE",
    permitted: "NOT_PERMITTED",
    startBidDate: new Date("2024-05-06"),
    endBidDate: new Date("2024-05-20"),
    startingBid: "100",
    highestBid: "0",
  };
  ...
  const onSubmit = async (data: FieldValues) => {
    ...
    if (data.startBidDate > data.endBidDate) {
      ...
      form.append("sellerId", dataFromUserToken.sub);
    ...
    <div>
      <Breadcrumb className="hidden md:flex">
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbLink asChild>
              <Link href="/dashboard/items/add">Add</Link>
            </BreadcrumbLink>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
